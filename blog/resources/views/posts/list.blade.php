...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <div class="posts">
            <figure class="group">
                <div><a class="imgover" href="#"><img src="{{ asset('images/demo/570x320.png') }}" alt=""></a></div>
                <figcaption>
    ...
    <section class="hoc container clear">
        ...
        <ul class="nospace group team">
            <li class="one_quarter first">
                <figure><a class="imgover" href="#"><img src="{{ asset('images/demo/300x300.png') }}" alt=""></a>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded" style="background-image:url({{ asset('images/demo/backgrounds/03.png') }});">
